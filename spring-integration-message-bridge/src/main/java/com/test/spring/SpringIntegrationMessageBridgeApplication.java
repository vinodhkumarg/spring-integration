...
public class SpringIntegrationMessageBridgeApplication implements ApplicationRunner {

    @Autowired
    PrintGateway printGateway;

    public static void main(String[] args) {
        SpringApplication.run(SpringIntegrationMessageBridgeApplication.class, args);
    }
